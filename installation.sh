...
# The g++ package is the GNU C++ compiler, which is required for compiling C++ code. i
...
# The mesa-common-dev package provides the Mesa 3D graphics library, which is an open-source implementation of the OpenGL specification. i
...
# The libglew-dev package contains the development files for the OpenGL Extension Wrangler Library (GLEW). i
